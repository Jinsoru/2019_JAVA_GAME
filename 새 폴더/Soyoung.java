...
public class Soyoung extends JPanel implements ActionListener, Runnable {
	   ...
	   public void init() {
	    ...
	    // exitButton 만들기
	 	...
	 	add(menuBar, BorderLayout.NORTH);
	      ...
	      randomString = new JLabel(getRandomString((int)(Math.random() * word.length)));
	   ...
	   public void nextWord() {
	      ...
	      randomString.setText(getRandomString((int)(Math.random() * word.length)));
	   }
	   ...
	   static public String getRandomString(int length) {
	      ...
	      for (int i = 0; i < 1; i++) {
	         answer = word[r.nextInt(word.length)];
